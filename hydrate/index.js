...
const BUILD = /* stencil-pw */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, devTools: false, disconnectedCallback: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: false, propString: true, reflect: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: true, state: true, style: false, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: false, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: false };
...
class MyApp {
  ...
  render() {
    return hAsync("div", null, hAsync("hr", null), hAsync("my-timer", null), hAsync("hr", null), hAsync("my-button", null), hAsync("hr", null), hAsync("my-form", null), hAsync("hr", null), hAsync("my-input", null), hAsync("hr", null), hAsync("text-field", { text: 'Hello from text stencil component--- hey basit' }));
  }
...
class MyButton {
  ...
  render() {
    return (hAsync("button", null, "Button"));
  }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "my-button",
...
class MyForm {
  ...
  render() {
    return (hAsync("form", { onSubmit: this.handleSubmit }, hAsync("div", null, hAsync("label", { htmlFor: "email" }, "Email:"), hAsync("input", { type: "email", id: "email", value: this.email, onInput: this.handleEmailChange, required: true })), hAsync("div", null, hAsync("label", { htmlFor: "password" }, "Password:"), hAsync("input", { type: "password", id: "password", value: this.password, onInput: this.handlePasswordChange, required: true })), hAsync("button", { type: "submit" }, "Submit")));
  }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "my-form",
...
class MyInput {
  ...
  render() {
    return (hAsync("div", null, hAsync("label", { htmlFor: "inputField" }, "Input:"), hAsync("input", { type: "text", id: "inputField", value: this.inputText, onInput: this.handleInputChange, placeholder: 'Write here' }), hAsync("p", null, "Text: ", this.inputText)));
  }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "my-input",
...
class MyTimer {
  ...
  render() {
    return (hAsync("p", null, "Here is running timer ", this.timerInSeconds, " Seconds"));
  }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "my-timer",
...
class TextField {
  ...
  render() {
    return (hAsync("div", null, hAsync("h2", null, "Text Field Element"), hAsync("h1", null, this.text)));
  }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "text-field",
